...
from geez.helper.basic import edit_or_reply, get_text, get_user
...
async def clone(client: Client, message: Message):
    ...
    if not user_:
        await op.edit("`Target clone tidak ditemukan`")
        return
    ...
    await message.edit(f"**Sekarang saya adalah** __{f_name}__")
