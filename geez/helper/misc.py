...
async def create_botlog(client):
    if HAPP is None:
        return
    LOGGER("geez").info("TUNGGU SEBENTAR. SEDANG MEMBUAT GROUP LOG USERBOT UNTUK ANDA")
    ...
    try:
        ...
        LOGGER("geez").warning(
            "var LOG_GROUP kamu belum di isi. Buatlah grup telegram dan masukan bot @Rose lalu ketik /id Masukan id grup nya di var LOG_GROUP"
        )
